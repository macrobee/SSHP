  ...
  return (
    <SectionDiv>
      ...
      >
        ...
        <motion.p variants={pVariants}>
          Send us a DM on our Instagram (@saddlesisterscycling) to ask about how
          to join our DISCORD chat group (or email info@saddlesisters.ca) Our
          rides are not OCA sanctioned.
        </motion.p>
        <motion.p variants={pVariants}>
